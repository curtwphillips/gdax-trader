var utility = (function () {
  ...
  function formatDateInput (dateObject) {
    ...
    var dateString = dateObject.getFullYear()+'-'+(month)+'-'+(day) ;
    return dateString;
  }
  ...
  function doMath (type, val1, val2) {
    ...
    var val1Decimals = countDecimals(val1);
    var val2Decimals = countDecimals(val2);
  ...
  function existy (x) { //true unless undefined or null
